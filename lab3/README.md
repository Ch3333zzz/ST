...
Я научился работать с Selenium WebDriver, изучил как он устроен, как взаимодействуют его компоненты. А также на основе построенной [use-case диаграммы](#use-case-диаграмма) я написал [прецеденты использования](#прецеденты-использования), которые помогли составить [чек-лист](#чек-лист) того, что я буду тестировать. На его основе были написаниы [тест-кейсы](#test-cases) и сами тесты.
