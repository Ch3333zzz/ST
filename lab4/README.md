...
Перед тестированием необходимо пробросить порт на локальную машину
...
Посольку нагрузочное и стресс тестирование разных конфигураций отличается лишь параметром в URL, я решил сделать .properties файл, чтобы удобнее менять параметры теста.
...
![ThreadGroupSettings](./resources/ThreadGroupSettings.png)
![DurationAssertionSettings](./resources/DurationAssertionSettings.png)
![TimerSettings](./resources/TimerSettings.png)
![HttpRequestSetting](./resources/HttpRequestSetting.png)
...
Параметры тестирования зафиксированы в [load.properties](./load.properties)
...
Приблизив последний график можно заметить
